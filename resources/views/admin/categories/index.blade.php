        ...
        <tbody class="list">
          @foreach ($categories as $categorie)
            <tr>
                ...
                <td class="text-end">
                    <div>
                        <a href="{{ route('categories.edit', ['category' => $categorie->id]) }}" class="btn btn-link p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                        ...
                        <form action="{{ route('categories.destroy', ['category' => $categorie->id]) }}" method="post" style="display: none" id="delete-form-{{$categorie->id}}">
                            @csrf
                            @method('delete')
                        </form>
