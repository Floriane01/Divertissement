                ...
                <div class="d-flex flex-between-center">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="../index-2.html">
                        <div class="d-flex align-items-center">
                            <img class="me-2" src={{ asset('../assets/img/icons/spot-illustrations/falcon.png') }}
                                alt="" width="40" />
                                    ...
                                    <div class="col-6 col-xxl-3">
                                        <div class="nav flex-column">
                                            <p class="nav-link text-700 mb-0 fw-bold">Other Auth</p><a
                                                ...
                                                class="nav-link py-1 link-600 fw-medium"
                                                href="../index.html#authentication-modal"
        ...
        <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
                ...
                <div class="d-flex align-items-center py-3"><img class="me-2"
                        ...
                        width="40" /><span class="font-sans-serif text-primary">EVENTS</span></div>
            </a>
        </div>
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                ...
                <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                    ...
                    <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                        ...
                        <div class="bg-white dark__bg-1000 rounded-2 py-2">
                            <a class="dropdown-item fw-bold text-warning" href="#!"><span
                                    class="fas fa-crown me-1"></span><span>Bienvenue</span></a>
                            {{-- <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#!">Set status</a>
                        <a class="dropdown-item" href="../pages/user/profile.html">Profile &amp; account</a>
                        <a class="dropdown-item" href="#!">Feedback</a> --}}
