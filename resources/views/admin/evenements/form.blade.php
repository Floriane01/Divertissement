                ...
                <div class="card-body bg-body-tertiary">
                        ...
                        <div class="row gx-2">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input class="form-control datetimepicker" name="date_debut" @error('date_debut')
                                    is-invalid @enderror id="start-date" type="text" placeholder="dd/mm/yy"
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" @error('lieu') is-invalid @enderror id="lieu" type="text"
                                    name="lieu" value="{{ $evenement->exists ? $evenement->lieu : old('lieu') }}" />
                                @error('lieu')
                                <span style="color: red; font-size: 0.7rem">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" @error('description') is-invalid @enderror
                                    id="event-description" rows="6" name="description"
                                    value="{{ $evenement->exists ? $evenement->description : old('description') }}">{{ $evenement->exists ? $evenement->description : old('description') }}</textarea>
                                @error('description')
                                <span style="color: red; font-size: 0.7rem">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="customFile">Couverture de votre évènement</label>
                                <input class="form-control" id="customFile" type="file" name="cover" />
                            </div>
                            @error('cover')
                            <span style="color: red; font-size: 0.7rem">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="card-body bg-body-tertiary">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="organizer" multiple="multiple" size="1"
                                ...
                                <option value="">Renseignez les organisateurs...</option>
                            </select>
                            @error('organisateur')
                            <span style="color: red; font-size: 0.7rem">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="sponsors" multiple="multiple" size="1" name="sponsors[]"
