...
@section('content')
  ...
  <div class="card cover-image mb-3"><img class="card-img-top" src="../../assets/img/generic/13.webp" alt="" /><input class="d-none" id="upload-cover-image" type="file" />
  ...
  <div class="row g-0">
    <div class="col-lg-8 pe-lg-2">
        ...
        <div class="card-body bg-body-tertiary">
          <form method="POST" action="{{ route($evenement->exists ? 'evenements.update' : 'evenements.store',  ['evenement' => $evenement->id])}}">
            ...
            <div class="row gx-2">
                ...
                <div class="col-6 col-xxl-6">
                    <label class="form-label" for="timepicker2">Date de l'évènement</label>
                    <input class="form-control datetimepicker" @error('date_debut') is-invalid @enderror id="timepicker2" type="text"  placeholder="dd/mm/yy to dd/mm/yy" data-options='{"mode":"range","dateFormat":"d/m/y","disableMobile":true}'  value="{{$evenement->exists ? $evenement->date_debut : ''}}"/>
                    @error('date_debut')
                        <span style="color: red; font-size: 0.7rem">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="col-6 col-xxl-6">
                    ...
                    <input class="form-control datetimepicker" @error('horaire') is-invalid @enderror id="timepicker1" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' value="{{$evenement->exists ? $evenement->horaire : ''}}"/>
                    @error('horaire')
                        <span style="color: red; font-size: 0.7rem">{{$message}}</span>
                    @enderror
                </div>
              ...
              <div class="col-6 col-xxl-6">
                <label class="form-label" for="datepicker">Date limite d'inscription</label>
                <input class="form-control datetimepicker" @error('deadline') is-invalid @enderror id="datepicker" type="text" placeholder="dd/mm/yy" data-options='{"disableMobile":true}' value="{{$evenement->exists ? $evenement->deadline : ''}}"/>
                @error('deadline')
                    <span style="color: red; font-size: 0.7rem">{{$message}}</span>
                @enderror
            </div>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body bg-body-tertiary">
            <button class="btn btn-falcon-default btn-sm" type="button">Free<span class="d-none d-sm-inline"> Ticket</span></button><button class="btn btn-falcon-primary btn-sm ms-2" type="button">Paid<span class="d-none d-sm-inline"> Ticket</span></button><button class="btn btn-falcon-default btn-sm ms-2" type="button">Donation</button>
    ...
    <div class="col-lg-4 ps-lg-2">
      <div class="sticky-sidebar">
        <div class="card mb-lg-0">
          ...
          <div class="card-body bg-body-tertiary">
            <div class="mb-3">
              <div class="d-flex flex-between-center"><label class="form-label" for="organizer">Organisateurs</label><button class="btn btn-link btn-sm pe-0" type="button">Add New</button></div><select class="form-select js-choice" id="organizer" multiple="multiple" size="1" name="organizer" data-options='{"removeItemButton":true,"placeholder":true}'>
                <option value="">Selectionnez organisateur...</option>
            ...
            <div class="mb-3">
              <div class="d-flex flex-between-center"><label class="form-label" for="sponsors">Sponsors</label><button class="btn btn-link btn-sm pe-0" type="button">Add New</button></div><select class="form-select js-choice" id="sponsors" multiple="multiple" size="1" name="sponsors" data-options='{"removeItemButton":true,"placeholder":true}'>
                <option value="">Selectionnez sponsors...</option>
