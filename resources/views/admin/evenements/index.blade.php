                    ...
                    <tbody class="list">
                        @foreach ($evenements as $evenement)
                            <tr>
                                ...
                                <td class="text-end">
                                    <div>
                                        <a href="{{ route('evenements.edit', ['marque' => $evenement->id]) }}"
                                        ...
                                        <form action="{{ route('evenements.destroy', ['evenement' => $evenement->id]) }}" method="post"
                                            style="display: none" id="delete-form-{{ $evenement->id }}">
                                            @csrf
                                            @method('delete')
                                        </form>
                                        <div class="modal fade" id="error-modal{{ $evenemnt->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content position-relative">
                                                    ...
                                                    <div class="modal-body p-0">
                                                        ...
                                                        <div class="p-4 pb-0">
                                                            <div>
                                                                <h5>Êtes-vous sûr de vouloir supprimer {{ $evenement->nom }}</h5>
                                                            </div>
                                                        </div>
                                                    </div>
