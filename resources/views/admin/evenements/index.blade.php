                                ...
                                <td class="text-end">
                                    <div>
                                        ...
                                        <div class="dropdown font-sans-serif d-inline-block mb-2">
                                            <button class="btn btn-link dropdown-toggle" id="dropdownMenuButton"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end py-0"
                                                ...
                                                <button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#addTicket-modal{{$evenement->id}}">
                                                    Ajouter un ticket
                                                </button>
                                        ...
                                        <div class="modal fade" id="addTicket-modal{{$evenement->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content position-relative">
                                                    ...
                                                    <div class="modal-body p-0">
                                                        <div class="rounded-top-3 py-3 ps-4 pe-6 bg-body-tertiary">
                                                            <h4 class="mb-1" id="modalExampleDemoLabel">Ajouter une nouvelle option de ticket</h4>
                                                        </div>
                                                        <div class="p-4 pb-0">
                                                            <form method="POST" action="{{ route('setTicketType', ['evenement' => $evenement->id])}}" id="ticketType-form-{{ $evenement->id }}">
                                                                @method('post')
                                                                @csrf
                                                                <input type="hidden" name="evenement_id" value="{{$evenement->id}}">
                                                                <div class="mb-3">
                                                                    <label class="col-form-label" for="option">Option:</label>
                                                                    <input class="form-control" id="option" name="option" type="text" value="{{old('option')}}" />
                                                                    @error('option')
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input class="form-control" type="text" name="prix" aria-label="Amount (to the nearest dollar)"  value="{{old('prix')}}"/>
                                                                ...
                                                                <div class="dropzone dropzone-single p-0" data-dropzone="data-dropzone" data-options='{"url":"valid/url","maxFiles":1,"dictDefaultMessage":"Choose or Drop a file here"}'>
                                                                    ...
                                                                    <div class="dz-preview dz-preview-single">
                                                                        <div class="dz-preview-cover dz-complete">
                                                                            ...
                                                                            <a
                                                                                class="dz-remove text-danger" href="#!" data-dz-remove="data-dz-remove">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button class="btn btn-primary" type="submit" form="ticketType-form-{{ $evenement->id }}">
                                                            Ajouter
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade" id="error-modal{{ $evenement->id }}" tabindex="-1"
